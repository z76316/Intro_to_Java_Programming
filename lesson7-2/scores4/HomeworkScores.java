...
public class HomeworkScores
{
    ...
    public void removeLowest()
    {
        ...
        //Find the lowest number in array "scores".
        double lowestNum = lowScore();
                
        //Get the location of the lowest number.
        int lowestLocation = find(lowestNum);
                
        //Remove the lowest number.
        remove(lowestLocation);        
    }
