...
public class Manager
{
    ...
    public void giveOutAssignments()
    {
        ...
        for(Photographer photographer : photographers)
        {
            ...
            {
                Assignment highestPriorityAssignment = getHighestPriorityAssignment();
                photographer.acceptAssignment(highestPriorityAssignment);
                assignments.remove(highestPriorityAssignment);
            }
            else
            {
                return;
